...
Version  : 23.04.3
Release  : 54
URL      : https://download.kde.org/stable/release-service/23.04.3/src/kmahjongg-23.04.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.3/src/kmahjongg-23.04.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.3/src/kmahjongg-23.04.3.tar.xz.sig
...
%prep
%setup -q -n kmahjongg-23.04.3
cd %{_builddir}/kmahjongg-23.04.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1688853129
mkdir -p clr-build
pushd clr-build
