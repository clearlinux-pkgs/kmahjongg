...
Version  : 23.04.1
Release  : 51
URL      : https://download.kde.org/stable/release-service/23.04.1/src/kmahjongg-23.04.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.1/src/kmahjongg-23.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.1/src/kmahjongg-23.04.1.tar.xz.sig
...
%prep
%setup -q -n kmahjongg-23.04.1
cd %{_builddir}/kmahjongg-23.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684794956
mkdir -p clr-build
pushd clr-build
