...
Source0  : https://download.kde.org/stable/release-service/24.05.2/src/kmahjongg-24.05.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.2/src/kmahjongg-24.05.2.tar.xz.sig
...
%setup -q -n kmahjongg-24.05.2
cd %{_builddir}/kmahjongg-24.05.2
pushd ..
cp -a kmahjongg-24.05.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720558885
mkdir -p clr-build
pushd clr-build
