...
Version  : 21.12.3
Release  : 36
URL      : https://download.kde.org/stable/release-service/21.12.3/src/kmahjongg-21.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.12.3/src/kmahjongg-21.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.12.3/src/kmahjongg-21.12.3.tar.xz.sig
...
%prep
%setup -q -n kmahjongg-21.12.3
cd %{_builddir}/kmahjongg-21.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1646534938
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kmahjongg-21.12.3/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/kmahjongg/7697008f58568e61e7598e796eafc2a997503fde
cp %{_builddir}/kmahjongg-21.12.3/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kmahjongg/3e8971c6c5f16674958913a94a36b1ea7a00ac46
pushd clr-build
%make_install
popd
%find_lang kmahjongg
